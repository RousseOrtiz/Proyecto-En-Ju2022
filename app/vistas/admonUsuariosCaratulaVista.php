...
<div class="card p-4 bg-light">
  ...
  <tbody>
    ...
    for($i=0; $i<count($datos['data']); $i++){
      ...
      print "<td><a href='".RUTA."admonUsuarios/cambio/".$datos["data"][$i]["id"]."' class='btn btn-info'></a></td>";
      print "<td><a href='".RUTA."admonUsuarios/baja/".$datos["data"][$i]["id"]."' class='btn btn-danger'></a></td>";
      print "</tr>";
    }
    ?>
  </tbody>
