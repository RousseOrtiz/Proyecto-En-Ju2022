  ...
  function registro(){
    ...
    if ($_SERVER['REQUEST_METHOD']=="POST") {
      ...
      if(count($errores)==0){
        ...
        if($r){
          $datos = [
          "titulo" => "The Rousse Clothing Store te da la Bienvenida",
          "menu" => false,
          "errores" => [],
          "data" => [],
          "subtitulo" => "Bienvenid@ a nuestra tienda",
          "texto" => "En nombre de nuestra empresa te damos la más sincera bienvenida a nuestra tienda virtual, en la que esperamos encuentres todo lo que necesitas.<br>
          <br>El objetivo principal de este canal de comunicación es brindarte confort y seguridad al portar nuestras prendas <br><br><br>Atentamente: Isela Ortiz, CEO",
          "color" => "alert-success",
          "url" => "menu",
          "colorBoton" => "btn-success",
          "textoBoton" => "Iniciar"
