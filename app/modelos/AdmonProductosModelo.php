...
class AdmonProductosModelo{
  ...
  public function modificaProducto($data){
    ...
    if (!empty($data["id"])) {
     ...
     //$sql.= "'', ";                                  //19. fecha baja
     $sql.= "talla='".$data['talla']."', ";            //20. autor
     $sql.= "publico='".$data['publico']."', ";        //21. publico
     $sql.= "objetivo='".$data['objetivo']."', ";      //22. objetivo
     $sql.= "necesario='".$data['necesario']."' ";     //23. necesario
  ...
  public function altaProducto($data){
    ...
    $sql.= "'".$data['publico']."', ";         //21. publico
    $sql.= "'".$data['objetivo']."', ";        //22. objetivo
    $sql.= "'".$data['necesario']."')";       //23. necesario
    print $sql;
